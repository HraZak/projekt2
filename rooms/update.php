    ...
    protected function body(): string
    {
        ...
        elseif ($this->state == self::STATE_PROCESSED) {
            ...
            if ($this->result == self::RESULT_SUCCESS) {
                return $this->m->render("roomSuccess", ['message' => "Room update successfully.", 'login' => $_SESSION['login']]);
            } else {
                return $this->m->render("roomFail", ['message' => "Room update failed.", 'login' => $_SESSION['login']]);
            }
        }
        return "";
    }
